...
FastUp is a tool created for IT organizations. Micro-services<sup>[6][6],[7][7]</sup> is a collection of design and architecture principles that are used by developers to realize functionality.  
